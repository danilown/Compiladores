...
fn main() {
   ...
   // let mut atual = Token{tok: ("").to_string(), tipe: 0 , line: 0, row: 0, escope: 0, used: false};
    ...
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
    println!("Used =  {}",atual.used);

    println!("___SEGUNDO_TOKEN__GOON_=_TRUE_");
    ...
    println!("___TERCEIRO_TOKEN__GOON_=_TRUE_");
    atual = Lexic(&mut result,true);
    println!("Token = {}",atual.tok);
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
    ...
    println!("___QUARTO_TOKEN__GOON_=_TRUE_");
    atual = Lexic(&mut result,true);
    println!("Token = {}",atual.tok);
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
    ...
    println!("___QUINTO_TOKEN__GOON_=_TRUE_");
    atual = Lexic(&mut result,true);
    println!("Token = {}",atual.tok);
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
    ...
    println!("___SEXTO_TOKEN__GOON_=_TRUE_");
    atual = Lexic(&mut result,true);
    println!("Token = {}",atual.tok);
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
    ...
    println!("___SETIMO_TOKEN__GOON_=_TRUE_");
    atual = Lexic(&mut result,true);
    println!("Token = {}",atual.tok);
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
    ...
    println!("___OITAVO_TOKEN__GOON_=_TRUE_");
    atual = Lexic(&mut result,true);
    println!("Token = {}",atual.tok);
    println!("Escope = {}",atual.escope);
    println!("Type =  {}",atual.tipe);
